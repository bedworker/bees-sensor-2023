...
cbar = common.plot_color(outside_temp,
                  average_temp,
                  norm=(0, 86400),
                  c_variable=timestamp,
                  cmap=mpl.colors.LinearSegmentedColormap.from_list("", ["black", "blue", "gray", "gray", "blue", "black"]),
                  cbar_label="Time of Day")

common.set_limits_and_labels("Outside Temperature (\u00b0C)",
                             "Average Camera Temperature (\u00b0C)",
                             (-15, 50),
                             (-15, 50))

common.trendline(outside_temp, average_temp)
